...
nes_exec (struct nes * nes)
{
    struct _opcode {
        ...
        {"NONE",    _call_none, 0,      0}, // 0x02
        {"NONE",    _call_none, 0,      0}, // 0x03
        {"NONE",    _call_none, 0,      0}, // 0x04
        {"ORA",     _call_ora,  2,      3}, // 0x05
        {"ASL",     _call_asl,  2,      5}, // 0x06
        {"NONE",    _call_none, 0,      0}, // 0x07
        {"PHP",     _call_php,  1,      3}, // 0x08
        {"ORA",     _call_ora,  2,      2}, // 0x09
        {"ASL",     _call_asl,  1,      2}, // 0x0A
        {"NONE",    _call_none, 0,      0}, // 0x0B
        {"NONE",    _call_none, 0,      0}, // 0x0C
        ...
        {"NONE",    _call_none, 0,      0}, // 0x74
        {"ADC",     _call_adc,  2,      4}, // 0x75
        {"ROR",     _call_ror,  2,      6}, // 0x76
        {"NONE",    _call_none, 0,      0}, // 0x77
        {"SEI",     _call_sei,  1,      2}, // 0x78
        {"ADC",     _call_adc,  3,      4}, // 0x79
        {"NONE",    _call_none, 0,      0}, // 0x7A
        {"NONE",    _call_none, 0,      0}, // 0x7B
        {"NONE",    _call_none, 0,      0}, // 0x7C
        {"ADC",     _call_adc,  3,      4}, // 0x7D
        {"ROR",     _call_ror,  3,      7}, // 0x7E
        {"NONE",    _call_none, 0,      0}, // 0x7F
        {"NONE",    _call_none, 0,      0}, // 0x80
        {"STA",     _call_sta,  2,      6}, // 0x81
        {"NONE",    _call_none, 0,      0}, // 0x82
        {"NONE",    _call_none, 0,      0}, // 0x83
        {"STY",     _call_sty,  2,      3}, // 0x84
        {"STA",     _call_sta,  2,      3}, // 0x85
        {"STX",     _call_stx,  2,      3}, // 0x86
        {"NONE",    _call_none, 0,      0}, // 0x87
        {"DEY",     _call_dey,  1,      2}, // 0x88
        {"NONE",    _call_none, 0,      0}, // 0x89
        {"TXA",     _call_txa,  1,      2}, // 0x8A
        {"NONE",    _call_none, 0,      0}, // 0x8B
        ...
        {"NONE",    _call_none, 0,      0}, // 0xF4
        {"SBC",     _call_sbc,  2,      4}, // 0xF5
        {"INC",     _call_inc,  2,      6}, // 0xF6
        {"NONE",    _call_none, 0,      0}, // 0xF7
        {"SED",     _call_sed,  1,      2}, // 0xF8
        {"SBC",     _call_sbc,  3,      4}, // 0xF9
        {"NONE",    _call_none, 0,      0}, // 0xFA
        {"NONE",    _call_none, 0,      0}, // 0xFB
        {"NONE",    _call_none, 0,      0}, // 0xFC
        {"SBC",     _call_sbc,  3,      4}, // 0xFD
        {"INC",     _call_inc,  3,      7}, // 0xFE
        {"NONE",    _call_none, 0,      0}, // 0xFF
    };
