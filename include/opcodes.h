...
struct _opcode {
    ...
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x02
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x03
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x04
    {"ORA",     _call_ora,  2,      3,  ADDR_MODE_ZPA   }, // 0x05
    {"ASL",     _call_asl,  2,      5,  ADDR_MODE_ZPA   }, // 0x06
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x07
    {"PHP",     _call_php,  1,      3,  ADDR_MODE_IMP   }, // 0x08
    {"ORA",     _call_ora,  2,      2,  ADDR_MODE_IMM   }, // 0x09
    {"ASL",     _call_asl,  1,      2,  ADDR_MODE_ACC   }, // 0x0A
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x0B
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x0C
    ...
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x74
    {"ADC",     _call_adc,  2,      4,  ADDR_MODE_ZPX   }, // 0x75
    {"ROR",     _call_ror,  2,      6,  ADDR_MODE_ZPX   }, // 0x76
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x77
    {"SEI",     _call_sei,  1,      2,  ADDR_MODE_IMP   }, // 0x78
    {"ADC",     _call_adc,  3,      4,  ADDR_MODE_ABY   }, // 0x79
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x7A
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x7B
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x7C
    {"ADC",     _call_adc,  3,      4,  ADDR_MODE_ABX   }, // 0x7D
    {"ROR",     _call_ror,  3,      7,  ADDR_MODE_ABX   }, // 0x7E
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x7F
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x80
    {"STA",     _call_sta,  2,      6,  ADDR_MODE_INX   }, // 0x81
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x82
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x83
    {"STY",     _call_sty,  2,      3,  ADDR_MODE_ZPA   }, // 0x84
    {"STA",     _call_sta,  2,      3,  ADDR_MODE_ZPA   }, // 0x85
    {"STX",     _call_stx,  2,      3,  ADDR_MODE_ZPA   }, // 0x86
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x87
    {"DEY",     _call_dey,  1,      2,  ADDR_MODE_IMP   }, // 0x88
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x89
    {"TXA",     _call_txa,  1,      2,  ADDR_MODE_IMP   }, // 0x8A
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0x8B
    ...
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0xF4
    {"SBC",     _call_sbc,  2,      4,  ADDR_MODE_ZPX   }, // 0xF5
    {"INC",     _call_inc,  2,      6,  ADDR_MODE_ZPX   }, // 0xF6
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0xF7
    {"SED",     _call_sed,  1,      2,  ADDR_MODE_IMP   }, // 0xF8
    {"SBC",     _call_sbc,  3,      4,  ADDR_MODE_ABY   }, // 0xF9
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0xFA
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0xFB
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0xFC
    {"SBC",     _call_sbc,  3,      4,  ADDR_MODE_ABX   }, // 0xFD
    {"INC",     _call_inc,  3,      7,  ADDR_MODE_ABX   }, // 0xFE
    {"INV",     _call_inv,  1,      0,  ADDR_MODE_IMP   }, // 0xFF
};
